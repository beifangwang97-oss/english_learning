  ...
  return (
    <main className="w-full min-h-screen flex items-center justify-center p-4 md:p-8 dopamine-bg">
      <div className="w-full max-w-6xl glass-panel rounded-xl overflow-hidden shadow-[0_32px_64px_-12px_rgba(37,49,42,0.12)] border border-white/30 flex flex-col md:flex-row min-h-[700px]">
        {/* Left Side: Playful Illustration & Brand */}
        <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-primary-container to-secondary-container p-12 flex-col justify-between relative overflow-hidden">
          ...
          <div className="z-10">
            ...
            <h2 className="font-headline font-extrabold text-5xl leading-tight text-on-primary-fixed mb-6">在冒险中精通英语</h2>
            <p className="text-on-primary-fixed-variant text-lg font-medium max-w-sm">加入 10,000 多名学生的行列，通过多巴胺驱动的学习方式提升语言技能。</p>
          </div>
        ...
        <div className="w-full md:w-1/2 p-8 md:p-16 flex flex-col justify-center bg-white/40">
          <div className="max-w-md mx-auto w-full">
            ...
            <header className="mb-10">
              <h3 className="font-headline font-extrabold text-4xl text-on-background mb-2">欢迎回来！</h3>
              <p className="text-on-surface-variant font-medium">准备好开始今天的学习之旅了吗？</p>
            </header>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                <label className="block font-label font-bold text-sm text-on-surface-variant ml-2">用户名或学生ID</label>
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center px-2">
                  <label className="block font-label font-bold text-sm text-on-surface-variant">安全密码</label>
            ...
            {/* Role Hinting */}
            <div className="mt-12 flex flex-col gap-3 opacity-80">
              <p className="text-xs font-bold text-center text-on-surface-variant mb-2">测试账号 (点击填入):</p>
              <div className="flex flex-wrap justify-center gap-3">
                <button
                  ...
                  className="bg-white/60 backdrop-blur-md px-4 py-2 rounded-full flex items-center gap-2 shadow-sm border border-white/20 hover:bg-white transition-colors"
                >
                  <div className="w-2 h-2 rounded-full bg-yellow-500"></div>
                  <span className="text-xs font-bold text-on-surface-variant">student / 123</span>
                </button>
                <button
                  onClick={() => {
                    setUsername('teacher');
                ...
                >
                  ...
                  <span className="text-xs font-bold text-on-surface-variant">teacher / 123</span>
                </button>
                <button
                  onClick={() => {
                    setUsername('admin');
                ...
                >
                  ...
                  <span className="text-xs font-bold text-on-surface-variant">admin / 123</span>
                </button>
              </div>
            </div>
          </div>
